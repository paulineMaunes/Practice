    ...
    function askQuestion() {
      ...
      // loop through choices, and create radio buttons
       for (var i = 0; i < choices.length; i++) {
        choicesHtml += "<div class='col-md-4'><ul><li><input type='radio' class='animated button fadeInUp' name='quiz" + currentQuestion +
          "' id='choice" + (i + 1) +
          "' value='" + choices[i] + "'>" +
          " <label class='animated button fadeInUp' for='choice" + (i + 1) + "'>" + choices[i] + "</label></ul></li></div>";
